...
- PlantUML preview sends encoded source to the HTTPS renderer selected in Settings only after consent for that renderer origin.
- Recent diagram source and settings are stored locally in the browser profile or desktop webview profile.
