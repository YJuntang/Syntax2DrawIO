...
| Mermaid ER | High | Some advanced directives and layout details may be simplified |
| Other Mermaid diagrams | Visual | Exported as Mermaid-rendered visual Draw.io artifacts |
...
| Other PlantUML families | Visual | Requires the configured HTTPS renderer |
